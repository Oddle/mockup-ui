...
export default function PickupHoursPage() {
  ...
  return (
    <Card>
      <CardContent className="pt-6 space-y-8">
        <div>
          <h2 className="text-2xl font-semibold">When can customers pickup an order?</h2>
          <p className="text-muted-foreground mt-2">
            Set pickup hours for your stores
          </p>
        </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center gap-2">
                  <div className={cn(
                    ...
                    !isCustomizing ? "border-primary bg-primary" : "border-muted-foreground"
                  )}>
                    {!isCustomizing && (
                  ...
                  <div>
                    <p className="font-medium">Apply to all stores</p>
                    <p className="text-sm text-muted-foreground mt-1">
                      Set buffer times that apply to all store operating hours
                    </p>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="font-medium">Customize for each store</p>
                    <p className="text-sm text-muted-foreground mt-1">
                      Set specific pickup hours for individual stores
                    </p>
                  </div>
                </div>
              </button>
